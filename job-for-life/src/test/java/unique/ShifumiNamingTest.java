...
import unique.ShifumiNaming.Out;
import unique.ShifumiNaming.PChoice;


public class ShifumiNamingTest {

	ShifumiNaming shifumi = new ShifumiNaming();
	
	@Test
	public void egaliteSiLesDeuxChoixSontCiseaux() {
		Out resultat = shifumi.execProcedurreX453(PChoice.PC_C, PChoice.PC_C);
		
		Assert.assertThat(resultat, CoreMatchers.equalTo(Out.RPE));
	}
